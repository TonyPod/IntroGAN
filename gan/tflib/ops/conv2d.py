...
from gan.tflib.ops.norm import weights_spectral_norm
...
def Conv2D(name, input_dim, output_dim, filter_size, inputs, he_init=True, mask_type=None, stride=1, weightnorm=None, spectral_norm=False, biases=True, gain=1.):
    """
    ...
    with tf.name_scope(name) as scope:
        ...
        if spectral_norm:
            filters = weights_spectral_norm(name, filters)
