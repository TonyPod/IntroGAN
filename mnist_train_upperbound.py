...
from gan.model_mnist_cnn import ClsNet
...
def main(_):
    ...
    if FLAGS.dataset == 'mnist':
        ...
        raw_images_train, train_labels, train_one_hot_labels, order = mnist.load_data(kind='train', order_idx=FLAGS.order_idx)
        raw_images_test, test_labels, test_one_hot_labels, order = mnist.load_data(kind='t10k', order_idx=FLAGS.order_idx)
    elif FLAGS.dataset == 'fashion-mnist':
        from utils import fashion_mnist
        raw_images_train, train_labels, train_one_hot_labels, order = fashion_mnist.load_data(kind='train', order_idx=FLAGS.order_idx)
        raw_images_test, test_labels, test_one_hot_labels, order = fashion_mnist.load_data(kind='t10k', order_idx=FLAGS.order_idx)
